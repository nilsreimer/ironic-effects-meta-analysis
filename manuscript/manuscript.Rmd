...
```{r, fig_width = "100%", fig.align = "center", fig.cap = "Results of preregistered analyses. (\\textbf{A}) Posterior distributions for the estimated mean correlation coefficient, highlighting the proportion of posterior samples for which $r_\\text{mean} < 0$. (\\textbf{B}) Posterior predictive distributions  for the estimated study-wise correlation coefficients."}
knitr::include_graphics("../figures/figure-3.pdf") 
```
